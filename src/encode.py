...
imagePaths = list(paths.list_images(abs_path + "images"))
...
pl2 = tk.Label(root, text="", fg="white", bg="#009999",
...
def encodeFaces():
    for (i, imagePath) in enumerate(imagePaths):
        ...
        encodingsFile.close()
        with open('data.csv', 'r') as f1, open('data1.csv', 'w', newline="") as out_file:

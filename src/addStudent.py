...
message = tk.Label(window, text="Auto attendance System", fg="white", bg="#009999",
                   width=32, height=2, font=('times', 30, 'italic bold underline')).grid(row=0)

lbl = tk.Label(window, text="Enter ID :", width=12, height=2,
               fg="white", bg="#0b4233", font=("arial", 16))
...
message = tk.Label(window, text="Enter Name and ID", width=20,
                   height=3, fg="green", bg="#a7bfcf", font=("arial", 16))
message.place(x=270, y=275)

lbl4 = tk.Label(window, text="Total Pictures :", fg="white",
                bg="#0b4233", font=("arial", 16))
lbl4.place(x=545, y=270)

entry = tk.Entry(window, fg="black", width=10,
                 bg="#e6e6e6", font=("arial", 16))
...
clearButton = tk.Button(window, text="Clear", command=clear,
                        width=10, fg="white", bg="#0b4233", font=("arial", 16))
